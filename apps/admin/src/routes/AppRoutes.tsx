...
export const router = createBrowserRouter([
  { path: "/login", element: <LoginPage /> },
  {
    ...
    children: [
      ...
      { path: "articles", element: <CrudPage config={configs.articles} /> },
      { path: "articles/new", element: <RecordFormPage config={configs.articles} /> },
      { path: "articles/:id/edit", element: <RecordFormPage config={configs.articles} /> },
